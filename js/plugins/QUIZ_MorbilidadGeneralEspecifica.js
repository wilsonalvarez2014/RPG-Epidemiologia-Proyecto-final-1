/*:
 * @plugindesc [v2.0] QUIZ Morbilidad General y especifica 
 * @author Luis
 * 
 ...
 *      $gameSystem.juegoCompletado2222()
 */
...
(function() {
    ...
    Object.defineProperty(window, 'mortalida', {
        get: function() {
            return $gameVariables.value(169);
        },
        set: function(valor) {
            $gameVariables.setValue(169, valor);
        }
    });
    ...
    Game_System.prototype.juegoCompletado2222 = function() {
        return this._juegoCompleto22 === true;
    };

    Game_System.prototype.establecerjuegoCompletado2222 = function(estado) {
        this._juegoCompleto22 = estado;
    };

    Game_System.prototype.juegoBloqueado2222 = function() {
        return this._juegoBloqueado22 === true;
    };

    Game_System.prototype.establecerBloqueo22 = function(estado2) {
        this._juegoBloqueado22 = estado2;
    };
    ...
    Game_Interpreter.prototype.pluginCommand = function(comando, args) {
        ...
        if (comando === "IniciarMorbilidad") {
            if ($gameSystem.lrmzJuegoBloqueado222()) {
                SceneManager.push(Scene_LRMZ_BloqueoFinal222);
                return;
            }
            
            if ($gameSystem.juegoCompletado2222()) {
                alert("Ya completaste este desafío con la máxima puntuación.");
                return;
            }
            // variable contador 2
            if ($gameVariables.value(170) === 0) {
                $gameVariables.setValue(170, 10) 
            }
            //establecer variable de juego
            if ($gameVariables.value(169) === 0) {
                $gameVariables.setValue(169, 10);
                
            }

            SceneManager.push(Escene_MTT);
        }
    };
    ...
    Escene_MTT.prototype = Object.create(Scene_Base.prototype);
    Escene_MTT.prototype.constructor = Escene_MTT;

    Escene_MTT.prototype.initialize = function() {
        Scene_Base.prototype.initialize.call(this);
    };

    Escene_MTT.prototype.terminate = function() {
        Scene_Base.prototype.terminate.call(this);
        Input.clear();
        TouchInput.clear();
    };

    Escene_MTT.prototype.create = function() {
    ...
    Escene_MTT.prototype.crearFondo = function() {
        this._fondo = new Sprite();
        const imagenFondo = ImageManager.loadBitmap('img/img_pluging/', 'imagen mortalidad')
  ...
  Escene_MTT.prototype.createInfoButton = function() {
...
//metod del boton de enlaces
  Escene_MTT.prototype.createConsultaButton = function() {
  const buttonX = 225;  
  const buttonY = 100;  
  ...
  Escene_MTT.prototype.createFinalScoreBox = function() {
  ...
  Escene_MTT.prototype.createScoreBox = function() {
  ...
  scoreBox.bitmap.drawText("Puntaje actividad: " + mortalida, 5, 5, 250, 40, 'left');


  this._scoreBox = scoreBox;
  this.addChild(scoreBox);
};
Escene_MTT.prototype.openConsultaWindow = function() {
  ...
  this.addChild(windowSprite);
      ...
      Escene_MTT.prototype.updateDragAndDrop = function() {
  ...
  Escene_MTT.prototype.resaltarCajasValidas = function(valor) {
  ...
  Escene_MTT.prototype.resetearResaltadoCajas = function() {
      for (const caja of this._cajas) {
          if (!caja._ocupada) {
              caja.bitmap.clear();
  ...
  Escene_MTT.prototype.update = function() {
...
Escene_MTT.prototype.crearElementosDeTexto = function() {
  this._elementos = [];
...
const variables = ['Municipio Santa María', 'Dengue', 'Fiebre Amarilla', 'Accidente ofídico','Intoxicación por plaguicidas','Enfermedad desconocida'];
    ...
    Escene_MTT.prototype.crearElementosArrastrables = function() {
        this._elementos = [];
        
        const valores = ['7,0', '11,3', '4,3', '8,7', '38,3', '5,2'];
        const posiciones = [
    ...
    Escene_MTT.prototype.crearCajasDestino = function() {
        this._cajas = [];
    ...
    Escene_MTT.prototype.getBoxGroups = function() {
    return [
        ['38,3'],    // caja 1
        ['4,3'],    // caja 2
        ['5,2'],     // caja 3
      ...
      Escene_MTT.prototype.crearBotonesInferiores = function() {
        ...
        const y = TouchInput.y;
          if (TouchInput.isTriggered()) {
            if (x >= this.x && x <= this.x + this.width &&
                ...
                if (isValid) {
                _finalScore += mortalida;
                const currentvida = $gameVariables.value(160);
                $gameVariables.setValue(160, currentvida + mortalida);
                $gameSystem.establecerjuegoCompletado2222(true);
                ...
                alert("✅ Prueba correcta. Se sumaron " + mortalida + " puntos al resultado final.");
                } else {
                    //validar el contador 2
                $gameVariables.setValue(170, $gameVariables.value(170) - 1);
                mortalida = Math.max(0, mortalida - 1);
                // Verificar si se acabaron los intentos
                if (mortalida <= 0 || $gameVariables.value(170) <= 0) {
                   $gameSystem.setlrmzJuegoBloqueado222(true);
                   SceneManager.push(Scene_LRMZ_BloqueoFinal222);
                   return;
                 }
                alert("❌ Respuestas incorrectas. Se restó 1 punto. Puntaje actual: " + mortalida);
                if (mortalida === 5) {
    ...
    Escene_MTT.prototype.validarRespuestas = function() {
      ...
      Escene_MTT.prototype.tryDrop = function(elementoArrastrable) {
  ...
  Escene_MTT.prototype.obtenerColorSegunTipo = function(valor) {
      // Colores diferentes para números vs porcentajes
      return valor.includes('%') ? '#f2f4f6ff' : '#fbf9f8ff'; //color al soltar
  };

  Escene_MTT.prototype.crearEfectoSoltado = function(x, y) {
  ...
  Escene_MTT.prototype.checkAllAnswers = function() {
 ...
 function Scene_LRMZ_BloqueoFinal222() {
  this.initialize.apply(this, arguments);
}

Scene_LRMZ_BloqueoFinal222.prototype = Object.create(Scene_Base.prototype);
Scene_LRMZ_BloqueoFinal222.prototype.constructor = Scene_LRMZ_BloqueoFinal222;

Scene_LRMZ_BloqueoFinal222.prototype.initialize = function() {
  Scene_Base.prototype.initialize.call(this);
};

Scene_LRMZ_BloqueoFinal222.prototype.create = function() {
  Scene_Base.prototype.create.call(this);

  // Imagen de fondo
  this._lrmzFondo = new Sprite();
  const bitmapFondo = ImageManager.loadBitmap('img/img_pluging/', 'mortalidadtarea3retroalimentacion', false);
...
DataManager.makeSaveContents = function() {
  ...
  contents.mortalida = mortalida;
  contents._finalScore = _finalScore;
  contents._lrmzJuegoBloqueado222 = $gameSystem.lrmzJuegoBloqueado222();
  return contents;
};
...
DataManager.extractSaveContents = function(contents) {
  ...
  mortalida = contents.mortalida || 0;
  _finalScore = contents._finalScore || 0;
  $gameSystem.setlrmzJuegoBloqueado222(contents._lrmzJuegoBloqueado222 || false);
};

// Métodos de acceso para el bloqueo
Game_System.prototype.lrmzJuegoBloqueado222 = function() {
  return this._lrmzJuegoBloqueado222 || false;
};

Game_System.prototype.setlrmzJuegoBloqueado222 = function(valor) {
  this._lrmzJuegoBloqueado222 = valor;
};
