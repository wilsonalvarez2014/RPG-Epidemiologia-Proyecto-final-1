/*:
 * @plugindesc [v2.0] QUIZ Mortalidad General y Especifica
 * @author Luis
 * 
 * 
 ...
 *      $gameSystem.juegoCompletadoMortalidad()
 */
...
(function() {
    ...
    Object.defineProperty(window, 'Mortalidad1', {
        get: function() {
            return $gameVariables.value(171);
        },
        set: function(valor) {
            $gameVariables.setValue(171, valor);
        }
    });
    ...
    Game_System.prototype.juegoCompletadoMortalidad = function() {
        return this._juegoCompleto22Mortalidad === true;
    };

    Game_System.prototype.establecerjuegoCompletadoMortalidad = function(estado11) {
        this._juegoCompleto22Mortalidad = estado11;
    };

    Game_System.prototype.juegoBloqueadoMortalidad = function() {
        return this._juegoBloqueado22Nortalidad === true;
    };

    Game_System.prototype.establecerBloqueo2211 = function(estado22) {
        this._juegoBloqueado22Nortalidad = estado22;
    };
    ...
    Game_Interpreter.prototype.pluginCommand = function(comando, args) {
        ...
        if (comando === "IniciarMortalidad") {
            if ($gameSystem.lrmzJuegoBloqueado2222()) {
                SceneManager.push(Scene_LRMZ_BloqueoFinal22222);
                return;
            }
            
            if ($gameSystem.juegoCompletadoMortalidad()) {
                alert("Ya completaste este desafío con la máxima puntuación.");
                return;
            }
            // variable contador 2
            if ($gameVariables.value(172) === 0) {
                $gameVariables.setValue(172, 10) 
            }
            //establecer variable de juego
            if ($gameVariables.value(171) === 0) {
                $gameVariables.setValue(171, 10);
                
            }

            SceneManager.push(Escene_MTTT);
        }
    };

    // Escena principal del minijuego
    function Escene_MTTT() {
        this.initialize.apply(this, arguments);
    }

    Escene_MTTT.prototype = Object.create(Scene_Base.prototype);
    Escene_MTTT.prototype.constructor = Escene_MTTT;

    Escene_MTTT.prototype.initialize = function() {
        Scene_Base.prototype.initialize.call(this);
    };

    Escene_MTTT.prototype.terminate = function() {
        Scene_Base.prototype.terminate.call(this);
        Input.clear();
        TouchInput.clear();
    };

    Escene_MTTT.prototype.create = function() {
    ...
    Escene_MTTT.prototype.crearFondo = function() {
        this._fondo = new Sprite();
        const imagenFondo = ImageManager.loadBitmap('img/img_pluging/', 'mortalidad imagen')
  ...
  Escene_MTTT.prototype.createInfoButton = function() {
...
//metod del boton de enlaces
  Escene_MTTT.prototype.createConsultaButton = function() {
  const buttonX = 225;  
  const buttonY = 100;  
  ...
  Escene_MTTT.prototype.createFinalScoreBox = function() {
  ...
  Escene_MTTT.prototype.createScoreBox = function() {
  ...
  scoreBox.bitmap.drawText("Puntaje actividad: " + Mortalidad1, 5, 5, 250, 40, 'left');


  this._scoreBox = scoreBox;
  this.addChild(scoreBox);
};
Escene_MTTT.prototype.openConsultaWindow = function() {
  ...
  this.addChild(windowSprite);
      ...
      Escene_MTTT.prototype.updateDragAndDrop = function() {
  ...
  Escene_MTTT.prototype.resaltarCajasValidas = function(valor) {
  ...
  Escene_MTTT.prototype.resetearResaltadoCajas = function() {
      for (const caja of this._cajas) {
          if (!caja._ocupada) {
              caja.bitmap.clear();
  ...
  Escene_MTTT.prototype.update = function() {
...
Escene_MTTT.prototype.crearElementosDeTexto = function() {
  this._elementos = [];
...
const variables = ['Municipio Santa María', 'Dengue', 'Fiebre Amarilla', 'Accidente ofídico','Intoxicación por plaguicidas','Enfermedad desconocida'];
    ...
    Escene_MTTT.prototype.crearElementosArrastrables = function() {
        this._elementos = [];
        
        const valores = ['0,9', '7,8', '4,3', '11,9', '1,7', '0,0'];
        const posiciones = [
    ...
    Escene_MTTT.prototype.crearCajasDestino = function() {
        this._cajas = [];
    ...
    Escene_MTTT.prototype.getBoxGroups = function() {
    return [
        ['7,8'],    // caja 1
        ['0,9'],    // caja 2
        ['0,9'],     // caja 3
      ...
      Escene_MTTT.prototype.crearBotonesInferiores = function() {
        ...
        const y = TouchInput.y;
          if (TouchInput.isTriggered()) {
            if (x >= this.x && x <= this.x + this.width &&
                ...
                if (isValid) {
                _finalScore += Mortalidad1;
                const currentvida = $gameVariables.value(160);
                $gameVariables.setValue(160, currentvida + Mortalidad1);
                $gameSystem.establecerjuegoCompletadoMortalidad(true);
                ...
                alert("✅ Prueba correcta. Se sumaron " + Mortalidad1 + " puntos al resultado final.");
                } else {
                    //validar el contador 2
                $gameVariables.setValue(172, $gameVariables.value(172) - 1);
                Mortalidad1 = Math.max(0, Mortalidad1 - 1);
                // Verificar si se acabaron los intentos
                if (Mortalidad1 <= 0 || $gameVariables.value(172) <= 0) {
                   $gameSystem.setlrmzJuegoBloqueado2222(true);
                   SceneManager.push(Scene_LRMZ_BloqueoFinal22222);
                   return;
                 }
                alert("❌ Respuestas incorrectas. Se restó 1 punto. Puntaje actual: " + Mortalidad1);
                if (Mortalidad1 === 5) {
    ...
    Escene_MTTT.prototype.validarRespuestas = function() {
      ...
      Escene_MTTT.prototype.tryDrop = function(elementoArrastrable) {
  ...
  Escene_MTTT.prototype.obtenerColorSegunTipo = function(valor) {
      // Colores diferentes para números vs porcentajes
      return valor.includes('%') ? '#f2f4f6ff' : '#fbf9f8ff'; //color al soltar
  };

  Escene_MTTT.prototype.crearEfectoSoltado = function(x, y) {
  ...
  Escene_MTTT.prototype.checkAllAnswers = function() {
 ...
 function Scene_LRMZ_BloqueoFinal22222() {
  this.initialize.apply(this, arguments);
}

Scene_LRMZ_BloqueoFinal22222.prototype = Object.create(Scene_Base.prototype);
Scene_LRMZ_BloqueoFinal22222.prototype.constructor = Scene_LRMZ_BloqueoFinal22222;

Scene_LRMZ_BloqueoFinal22222.prototype.initialize = function() {
  Scene_Base.prototype.initialize.call(this);
};

Scene_LRMZ_BloqueoFinal22222.prototype.create = function() {
  Scene_Base.prototype.create.call(this);

  // Imagen de fondo
  this._lrmzFondo = new Sprite();
  const bitmapFondo = ImageManager.loadBitmap('img/img_pluging/', 'imagen mortalidad retro', false);
...
DataManager.makeSaveContents = function() {
  ...
  contents.Mortalidad1 = Mortalidad1;
  contents._finalScore = _finalScore;
  contents._lrmzJuegoBloqueado2222 = $gameSystem.lrmzJuegoBloqueado2222();
  return contents;
};
...
DataManager.extractSaveContents = function(contents) {
  ...
  Mortalidad1 = contents.Mortalidad1 || 0;
  _finalScore = contents._finalScore || 0;
  $gameSystem.setlrmzJuegoBloqueado2222(contents._lrmzJuegoBloqueado2222 || false);
};

// Métodos de acceso para el bloqueo
Game_System.prototype.lrmzJuegoBloqueado2222 = function() {
  return this._lrmzJuegoBloqueado2222 || false;
};

Game_System.prototype.setlrmzJuegoBloqueado2222 = function(valor) {
  this._lrmzJuegoBloqueado2222 = valor;
};
