/*:
 * @plugindesc [v2.0] QUIZ de dencidad
 * @author Luis
 * 
 ...
 *     $gameSystem.juegoCompletadodencidad()
 * 
 */
...
(function() {
    ...
    Object.defineProperty(window, 'dencidad', {
        get: function() {
            return $gameVariables.value(185);
        },
        set: function(valor) {
            $gameVariables.setValue(185, valor);
        }
    });
    ...
    Game_System.prototype.juegoCompletadodencidad = function() {
        return this._juegoCompleto22dencidad === true;
    };

    Game_System.prototype.establecerjuegoCompletadodencidad = function(estado15) {
        this._juegoCompleto22dencidad = estado15;
    };

    Game_System.prototype.juegoBloqueadodencidad = function() {
        return this._juegoBloqueado22dencidad === true;
    };

    Game_System.prototype.establecerBloqueodencidad = function(estado24) {
        this._juegoBloqueado22dencidad = estado24;
    };
    ...
    Game_Interpreter.prototype.pluginCommand = function(comando, args) {
        ...
        if (comando === "Iniciardencidad") {
            if ($gameSystem.lrmzJuegoBloqueadodencidad()) {
                SceneManager.push(Scene_LRMZ_BloqueoFinaldencidad);
                return;
            }
            
            if ($gameSystem.juegoCompletadodencidad()) {
                alert("Ya completaste este desafío con la máxima puntuación.");
                return;
            }
            // variable contador 2
            if ($gameVariables.value(186) === 0) {
                $gameVariables.setValue(186, 10) 
            }
            //establecer variable de juego
            if ($gameVariables.value(185) === 0) {
                $gameVariables.setValue(185, 10);
                
            }

            SceneManager.push(Escene_MTTTTTTTTTT);
        }
    };

    // Escena principal del minijuego
    function Escene_MTTTTTTTTTT() {
        this.initialize.apply(this, arguments);
    }

    Escene_MTTTTTTTTTT.prototype = Object.create(Scene_Base.prototype);
    Escene_MTTTTTTTTTT.prototype.constructor = Escene_MTTTTTTTTTT;

    Escene_MTTTTTTTTTT.prototype.initialize = function() {
        Scene_Base.prototype.initialize.call(this);
    };
    Escene_MTTTTTTTTTT.prototype.terminate = function() {
        Scene_Base.prototype.terminate.call(this);
        Input.clear();
        TouchInput.clear();
    };

    Escene_MTTTTTTTTTT.prototype.create = function() {
    ...
    Escene_MTTTTTTTTTT.prototype.crearFondo = function() {
        this._fondo = new Sprite();
        const imagenFondo = ImageManager.loadBitmap('img/img_pluging/', 'dencidad')
  ...
  Escene_MTTTTTTTTTT.prototype.createInfoButton = function() {
...
//metod del boton de enlaces
  Escene_MTTTTTTTTTT.prototype.createConsultaButton = function() {
  const buttonX = 225;  
  const buttonY = 100;  
  ...
  Escene_MTTTTTTTTTT.prototype.createFinalScoreBox = function() {
  ...
  Escene_MTTTTTTTTTT.prototype.createScoreBox = function() {
  ...
  scoreBox.bitmap.drawText("Puntaje actividad: " + dencidad, 5, 5, 250, 40, 'left');


  this._scoreBox = scoreBox;
  this.addChild(scoreBox);
};
Escene_MTTTTTTTTTT.prototype.openConsultaWindow = function() {
  ...
  this.addChild(windowSprite);
      ...
      Escene_MTTTTTTTTTT.prototype.updateDragAndDrop = function() {
  ...
  Escene_MTTTTTTTTTT.prototype.resaltarCajasValidas = function(valor) {
  ...
  Escene_MTTTTTTTTTT.prototype.resetearResaltadoCajas = function() {
      for (const caja of this._cajas) {
          if (!caja._ocupada) {
              caja.bitmap.clear();
  ...
  Escene_MTTTTTTTTTT.prototype.update = function() {
    ...
    Escene_MTTTTTTTTTT.prototype.crearElementosArrastrables = function() {
        this._elementos = [];
        
        const valores = ['46', '7', '15,2', '22', '4', '18,2'];
        const posiciones = [
    ...
    Escene_MTTTTTTTTTT.prototype.crearCajasDestino = function() {
        this._cajas = [];
        ...
        const posicionesCajas = [
            // Columna 1
            {x: 570, y: 193 }, {x: 570, y: 238}, {x: 570, y: 283},
            
            // Columna 2
            {x: 570, y: 328}, {x: 572, y: 421}, {x: 572, y: 463},
    ...
    Escene_MTTTTTTTTTT.prototype.getBoxGroups = function() {
    return [
        ['4'],    // caja 1
        ['22'],    // caja 2
        ['7'],     // caja 3
      ...
      Escene_MTTTTTTTTTT.prototype.crearBotonesInferiores = function() {
        ...
        const y = TouchInput.y;
          if (TouchInput.isTriggered()) {
            if (x >= this.x && x <= this.x + this.width &&
                ...
                if (isValid) {
                _finalScore += dencidad;
                const currentvida = $gameVariables.value(160);
                $gameVariables.setValue(160, currentvida + dencidad);
                $gameSystem.establecerjuegoCompletadodencidad(true);
                ...
                alert("✅ Prueba correcta. Se sumaron " + dencidad + " puntos al resultado final.");
                } else {
                    //validar el contador 2
                $gameVariables.setValue(186, $gameVariables.value(186) - 1);
                dencidad = Math.max(0, dencidad - 1);
                // Verificar si se acabaron los intentos
                if (dencidad <= 0 || $gameVariables.value(186) <= 0) {
                   $gameSystem.setlrmzJuegoBloqueadodencidad(true);
                   SceneManager.push(Scene_LRMZ_BloqueoFinaldencidad);
                   return;
                 }
                alert("❌ Respuestas incorrectas. Se restó 1 punto. Puntaje actual: " + dencidad);
                if (dencidad === 5) {
    ...
    Escene_MTTTTTTTTTT.prototype.validarRespuestas = function() {
      ...
      Escene_MTTTTTTTTTT.prototype.tryDrop = function(elementoArrastrable) {
  ...
  Escene_MTTTTTTTTTT.prototype.obtenerColorSegunTipo = function(valor) {
      // Colores diferentes para números vs porcentajes
      return valor.includes('%') ? '#f2f4f6ff' : '#fbf9f8ff'; //color al soltar
  };

  Escene_MTTTTTTTTTT.prototype.crearEfectoSoltado = function(x, y) {
  ...
  Escene_MTTTTTTTTTT.prototype.checkAllAnswers = function() {
 ...
 function Scene_LRMZ_BloqueoFinaldencidad() {
  this.initialize.apply(this, arguments);
}

Scene_LRMZ_BloqueoFinaldencidad.prototype = Object.create(Scene_Base.prototype);
Scene_LRMZ_BloqueoFinaldencidad.prototype.constructor = Scene_LRMZ_BloqueoFinaldencidad;

Scene_LRMZ_BloqueoFinaldencidad.prototype.initialize = function() {
  Scene_Base.prototype.initialize.call(this);
};

Scene_LRMZ_BloqueoFinaldencidad.prototype.create = function() {
  Scene_Base.prototype.create.call(this);

  // Imagen de fondo
  this._lrmzFondo = new Sprite();
  const bitmapFondo = ImageManager.loadBitmap('img/img_pluging/', 'dencidad retro', false);
...
DataManager.makeSaveContents = function() {
  ...
  contents.dencidad = dencidad;
  contents._finalScore = _finalScore;
  contents._lrmzJuegoBloqueadodencidad = $gameSystem.lrmzJuegoBloqueadodencidad();
  return contents;
};
...
DataManager.extractSaveContents = function(contents) {
  ...
  dencidad = contents.dencidad || 0;
  _finalScore = contents._finalScore || 0;
  $gameSystem.setlrmzJuegoBloqueadodencidad(contents._lrmzJuegoBloqueadodencidad || false);
};

// Métodos de acceso para el bloqueo
Game_System.prototype.lrmzJuegoBloqueadodencidad = function() {
  return this._lrmzJuegoBloqueadodencidad || false;
};

Game_System.prototype.setlrmzJuegoBloqueadodencidad = function(valor) {
  this._lrmzJuegoBloqueadodencidad = valor;
};
